...
# pasted straight into an (elevated) cmd prompt — no script execution needed.
set -euo pipefail
...
echo "  $cmd"
echo "paste into an elevated cmd prompt to run it (kmonad needs admin rights for its low-level-hook)"
